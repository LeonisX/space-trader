...
public class FormCargoSell extends SpaceTraderForm
{
	...
	private void InitializeComponent()
	{
		...
		lblQuestion.setSize(new Size(160, 13));
		...
		lblStatement.setSize(new Size(302, 13));
		...
		numAmount.setSize(new Size(38, 20));
		...
		btnNone.setSize(new Size(41, 22));
		...
		lblPaid.setSize(new Size(280, 13));
		...
		lblProfit.setSize(new Size(200, 13));
