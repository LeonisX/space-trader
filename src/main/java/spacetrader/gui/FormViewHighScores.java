...
import spacetrader.Strings;
	public class FormViewHighScores extends SpaceTraderForm
	{
		...
		private void InitializeComponent()
		{
			...
			lblRank0.setSize(new Size(14, 13));
			...
			lblRank2.setSize(new Size(14, 13));
			...
			lblRank1.setSize(new Size(14, 13));
			...
			lblScore0.setSize(new Size(43, 13));
			...
			lblScore1.setSize(new Size(43, 13));
			...
			lblScore2.setSize(new Size(43, 13));
			...
			lblName0.setSize(new Size(144, 13));
			...
			lblName1.setSize(new Size(144, 13));
			...
			lblName2.setSize(new Size(144, 13));
			...
			lblStatus0.setSize(new Size(200, 26));
			...
			lblStatus1.setSize(new Size(200, 26));
			...
			lblStatus2.setSize(new Size(200, 26));
