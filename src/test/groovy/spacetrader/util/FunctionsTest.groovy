...
class FunctionsTest extends Specification {
    ...
    //TODO news, encounters, mercenaries, difficulty
    @SuppressWarnings("all")
    def "write game to file, load and verify"() {
        ...
        Game game = new Game(
                commander:
                        new Commander(id: CrewMemberId.COMMANDER.castToInt(), skills: [3, 4, 5, 6], currentSystemId: StarSystemId.Bretel,
                ...
                /*mercenaries: [
                        new CrewMember(id: CrewMemberId.ARAGORN.castToInt(), skills: [3, 4, 5, 6], currentSystemId: StarSystemId.Bretel),
                        new CrewMember(id: CrewMemberId.ALYSSA.castToInt(), skills: [7, 6, 5, 4], currentSystemId: StarSystemId.NA)
                ],*/
                ...
                opponent: new Ship(type: ShipType.BEETLE, size: Size.LARGE, cargoBays: 24, weaponSlots: 3,
                        ...
                        traders: Activity.SWARMS, minTech: TechLevel.HI_TECH, imageIndex: 56, fuel: 777,
                        hull: 778, cargo: [90, 91, 92, 93, 94, 95, 96, 97, 98, 99],
                        weapons: [
                        ...
                        crewMembers: [new CrewMember(id: CrewMemberId.C2U2.castToInt(), skills: [0, 0, 0, 0], currentSystemId: StarSystemId.Guinifer)],
                        pod: true,
                ...
                autoSave: true,
                //easyEncounters: true,
                endStatus: GameEndType.BOUGHT_MOON.castToInt(),
