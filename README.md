...
# Quest phases:
PhaseGemulonTitle=Alien Invasion
PhaseGemulonMessage=We received word that aliens will invade Gemulon seven days from now. We know exactly at which coordinates they will arrive, but we can't warn Gemulon because an ion storm disturbs all forms of communication. We need someone, anyone, to deliver this info to Gemulon within six days.
PhaseGemulonRescuedTitle=Gemulon Rescued
PhaseGemulonRescuedMessage=This information of the arrival of the alien invasion force allows us to prepare a defense. You have saved our way of life. As a reward, we have a fuel compactor gadget for you, which will increase the travel distance by 3 parsecs for any ship. Return here to get it installed.
PhaseGemulonFuelTitle=Fuel Compactor
PhaseGemulonFuelMessage=Do you wish us to install the fuel compactor on your current ship? (You need a free gadget slot)
PhaseGemulonInvadedTitle=Gemulon Invaded
PhaseGemulonInvadedMessage=Alas, Gemulon has been invaded by aliens, which has thrown us back to pre-agricultural times. If only we had known the exact coordinates where they first arrived at our system, we might have prevented this tragedy from happening.
...
# Alerts:
AlertEquipmentFuelCompactorTitle=Fuel Compactor
AlertEquipmentFuelCompactorMessage=You now have a fuel compactor installed on your ship.

# News:
NewsGemulon=Editorial: Who Will Warn Gemulon?
NewsGemulonRescued=Invasion Imminent! Plans in Place to Repel Hostile Invaders.
NewsGemulonInvaded=Alien Invasion Devastates Planet!

# Cheat Titles:
CheatGemulon=Gemulon
...
# Quest phases:
PhaseGemulonTitle=Вторжение пришельцев
PhaseGemulonMessage=Мы получили известие о том, что инопланетяне планируют вторгнуться в систему Гемулон через семь дней. Мы точно знаем координаты их прибытия, но мы не можем предупредить Гемулон, потому что ионный шторм нарушает работу всех видов передатчиков. Нам нужен кто-то, кто угодно, кто передаст эту информацию в Гемулон в течение шести дней.
PhaseGemulonRescuedTitle=Гемулон был спасён
PhaseGemulonRescuedMessage=Ваша информация о прибытии сил вторжения пришельцев даёт нам возможность подготовиться к обороне. Вы спасли наш жизненный уклад. В качестве награды у нас для вас есть устройство, топливный уплотнитель. Он увеличивает дальность полёта любого корабля на 3 парсека. Возвращайтесь сюда, чтобы установить его.
PhaseGemulonFuelTitle=Уплотнитель топлива
PhaseGemulonFuelMessage=Вы хотите, чтобы мы установили на ваш корабль топливный уплотнитель? (Вам нужен свободный слот для устройства)
PhaseGemulonInvadedTitle=Гемулон была захвачен
PhaseGemulonInvadedMessage=Увы, пришельцы вторглись в систему Гемулон, и отбросили наше развитие в каменный век. Если бы мы только знали точные координаты их прибытия, то могли бы предотвратить эту трагедию.

# Quest clues:
QuestGemulonInformDays=В течении ^1 проинформировать систему Гемулон о вторжении пришельцев.
QuestGemulonInformTomorrow=До завтра проинформировать систему Гемулон о вторжении пришельцев.
QuestGemulonFuel=Забрать ваш уплотнитель топлива в системе Гемулон.

# Alerts:
AlertEquipmentFuelCompactorTitle=Уплотнитель топлива
AlertEquipmentFuelCompactorMessage=Теперь на вашем корабле установлен топливный уплотнитель.

# News:
NewsGemulon=Передовица: кто предупредит Гемулон?
NewsGemulonRescued=Вторжение неизбежно! Принято решение отразить атаку враждебных захватчиков.
NewsGemulonInvaded=Вторжение инопланетян опустошает планету!

# Cheat Titles:
CheatGemulon=Гемулон
