...
# Quest phases:
PhaseSculptureTitle=Украденная скульптура
PhaseSculptureMessage=В доке к вам приближается некто в капюшоне и интересуется, не согласитесь ли вы доставить недавно приобретённый товар в систему Эндор. Он показывает маленькую скульптуру человека, держащего какой-то световой меч. Вы подозреваете, что она была украдена. Похоже, что статуя сделана из пластика и не очень ценна. "Я заплачу вам 2 000 кредитов сейчас, плюс 15 000 при доставке", - негромко произносит незнакомец. Увидев выражение вашего лица, он добавляет: - "Это коллекционная вещица. Возьмётесь за доставку, или нет?"
PhaseSculptureDeliveredTitle=Скульптура доставлена
PhaseSculptureDeliveredMessage=Приближается ещё одна тёмная фигура в капюшоне. "У вас есть экшен фигур... ммм скульптура?" Вы передаёте её и слышите из-под капюшона, что-то, звучащее как хихиканье. "Я знаю, что за доставку вам было обещано 15 000 кредитов, но прямо сейчас у меня нет таких денег, зато имеется что-то получше. Мой знакомый может установить на вашем корабле скрытые грузовые отсеки". Возвращайтесь со свободным слотом для устройства, когда будете готовы к их установке.
PhaseSculptureHiddenBaysTitle=Установка скрытых отсеков
PhaseSculptureHiddenBaysMessage=Вы попадаете на склад и протискиваетесь через скрипучую, ржавую дверь. К вам приближается неопрятный инопланетянин гуманоидного вида, но вы не уверены, какого именно. "Вот, значит кому понадобились потаённые отсеки. Установить их на вашем корабле?" (Для этого потребуется свободный слот для устройства.)

# Quest clues:
QuestSculpture=Доставить похищенную скульптуру в систему Эндор.
QuestSculptureHiddenBays=Установить скрытые грузовые отсеки в системе Эндор.

# Alerts:
AlertEncounterPiratesTakeSculptureTitle=Пираты забрали скульптуру
AlertEncounterPiratesTakeSculptureMessage=Когда пираты обшаривали ваш корабль, они нашли украденную скульптуру. "Это стоит тысячи!" - закричал один из них, пряча скульптуру в своём рюкзаке.
AlertEquipmentHiddenCompartmentsTitle=Скрытые грузовые отсеки
AlertEquipmentHiddenCompartmentsMessage=Теперь у вашего корабля есть 5 скрытых грузовых отсеков. Полиция не сможет обнаружить в них запрещённые товары.
AlertJailHiddenCargoBaysRemovedTitle=Потайные отсеки были удалены
AlertJailHiddenCargoBaysRemovedMessage=Когда ваш корабль был конфискован, полицейские перебрали его до последнего винтика. Все потайные грузовые отсеки были найдены и демонтированы.
AlertSculptureConfiscatedTitle=Полиция конфисковала скульптуру
AlertSculptureConfiscatedMessage=Полиция конфисковала украденную скульптуру и возвратила её законному владельцу.
AlertSculptureSavedTitle=Скульптура спасена
AlertSculptureSavedMessage=По пути к спасательной капсуле вы успеваете прихватить украденную скульптуру. Ну, по-крайней мере вы спасли хоть что-то.

# News:
NewsPricelessCollectorsItemWasStolen=Бесценная коллекционная вещь была украдена из дома Джурджа Локаса!
NewsSpaceCorpsFollowsSculptureCaptors=Космический Корпус преследует в системе ^2 ^^3 с предполагаемой украденной скульптурой.

# Encounters:
EncounterHideSculpture=украденную скульптуру
EncounterPoliceSubmitSculpture=украденная скульптура
EncounterPoliceSurrenderSculpture=конфискуют скульптуру

# Special Cargo Titles:
SpecialCargoSculpture=Похищенная пластмассовая скульптура человека, держащего какой-то световой меч.

# Cheat Titles:
CheatSculpture=Скульптура
